...
question_table <- read.csv(file = 'old_rescoring/242_Blank_Master_Question_List.csv')
...
answers_data <- read.csv('old_rescoring/242_cat_response_table.csv',as.is=TRUE)
